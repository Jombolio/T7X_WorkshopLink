...
1. Like `t7x.exe`, download https://jombo.uk/resources/WorkshopLink.bat and move `WorkshopLink.bat` into the Steam Installation for Call of Duty: Black Ops III.
